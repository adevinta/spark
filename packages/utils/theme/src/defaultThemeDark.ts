...
export const defaultThemeDark: Theme = createTheme({
  colors: {
    ...
    primaryContainerPressed: '#080632',
    ...
    secondaryContainerPressed: '#3F0E22',
    ...
    secondaryVariantPressed: '#FE6BA7',
