...
export const defaultTheme: Theme = {
  ...
  fontSize: {
    display1: { fontSize: '6rem', lineHeight: '8rem' },
    display2: { fontSize: '5rem', lineHeight: '7rem' },
    display3: { fontSize: '4rem', lineHeight: '5.5rem' },
    headline1: { fontSize: '3rem', lineHeight: '4rem' },
    headline2: { fontSize: '2.5rem', lineHeight: '3.5rem' },
