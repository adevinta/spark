...
export const defaultTheme: Theme = {
  ...
  fontSize: {
    ...
    subhead: { fontSize: '2rem', lineHeight: '3rem', letterSpacing: '0.5rem' },
    body1: { fontSize: '2rem', lineHeight: '3rem' },
    body2: { fontSize: '1.75rem', lineHeight: '2.5rem' },
    caption: { fontSize: '1.5rem', lineHeight: '2.5rem' },
    small: { fontSize: '1.25rem', lineHeight: '1.75rem', letterSpacing: '0.5rem' },
    ...
    callout: { fontSize: '2rem', lineHeight: '3rem', letterSpacing: '1rem' },
  },
  fontWeight: {
    regular: '400',
    medium: '500',
