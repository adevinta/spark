...
export const defaultTheme: Theme = {
  ...
  fontSize: {
    // small screens
    mention: { fontSize: '10px', lineHeight: '16px' },
    mentionBold: { fontSize: '10px', lineHeight: '16px', fontWeight: '700' },
    // standard screens
    captionLink: { fontSize: '12px', lineHeight: '16px' },
    captionLinkBold: { fontSize: '12px', lineHeight: '16px', fontWeight: '700' },
    bodyLink: { fontSize: '14px', lineHeight: '24px' },
    bodyLinkBold: { fontSize: '14px', lineHeight: '24px', fontWeight: '700' },
    caption: { fontSize: '12px', lineHeight: '16px' },
    captionBold: { fontSize: '12px', lineHeight: '16px', fontWeight: '700' },
    body: { fontSize: '14px', lineHeight: '24px' },
    bodyBold: { fontSize: '14px', lineHeight: '24px', fontWeight: '700' },
    subhead: { fontSize: '16px', lineHeight: '24px' },
    subheadBold: { fontSize: '16px', lineHeight: '24px', fontWeight: '700' },
    headline2: { fontSize: '20px', lineHeight: '32px', fontWeight: '700' },
    headline1: { fontSize: '24px', lineHeight: '32px', fontWeight: '700' },
    // large screens
    display3: { fontSize: '32px', lineHeight: '48px', fontWeight: '700' },
    display2: { fontSize: '40px', lineHeight: '56px', fontWeight: '700' },
    display1: { fontSize: '48px', lineHeight: '50px', fontWeight: '700' },
  },
  screens: {
    sm: '640px',
    md: '768px',
