...
**Note: For headings inside Popover, please use the `header` HTML tag instead of `h1, h2`, etc.**
...
- `Space`: Open/Closes the popover.
- `Enter`: Open/Closes the popover.
- `Tab`: Moves focus to the next focusable element.
- `Shift + Tab`: Moves focus to the previous focusable element.
- `Esc`: Closes the popover and moves focus back to `Popover.Trigger`.
