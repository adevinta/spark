...
describe('Popover', () => {
  ...
  describe('uncontrolled mode (stateful)', () => {
    describe('opening', () => {
      it('should open popover on click', async () => {
        ...
        expect(
          document.querySelector('[data-spark-component="popover-anchor"]')
        ).toBeInTheDocument()
        expect(
          document.querySelector('[data-spark-component="popover-trigger"]')
        ).toBeInTheDocument()
        ...
        expect(
          document.querySelector('[data-spark-component="popover-content"]')
        ).toBeInTheDocument()
