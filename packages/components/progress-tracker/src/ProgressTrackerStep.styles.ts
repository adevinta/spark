...
export const stepItemVariant = cva(
  [
    ...
    'group-data-[orientation=horizontal]/list:px-[2px]',
    ...
    'group-data-[orientation=vertical]/list:after:w-[1px] group-data-[orientation=vertical]/list:after:bottom-none',
  ],
  {
    variants: {
      size: {
        sm: [
          ...
          'group-data-[orientation=vertical]/list:after:top-[24px]',
          'group-data-[orientation=vertical]/list:first:after:top-[20px]',
        ],
        md: [
          // Horizontal orientation
          ...
          'group-data-[orientation=vertical]/list:after:top-[32px]',
          'group-data-[orientation=vertical]/list:first:after:top-[28px]',
        ],
        lg: [
          // Horizontal orientation
          ...
          'group-data-[orientation=vertical]/list:after:top-[40px]',
          'group-data-[orientation=vertical]/list:first:after:top-[36px]',
        ],
      },
      disabled: {
...
export const stepButtonVariant = cva(
  [
    'relative flex items-start group/btn',
    // 'bg-main/dim-3',
    // Horizontal orientation
    ...
    variants: {
      size: {
        sm: [
          ...
          'before:inline-flex before:h-sz-16',
        ],
        md: [
