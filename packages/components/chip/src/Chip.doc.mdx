...
The max length of any Chip is 240px including its borders, icons, and clear button.
...
When there is an action declared to the chip, it also applies hover and focus intents.
