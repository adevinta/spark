...
<Callout kind="warning">
  Interactive Chips represent Call to Action elements
  and should never be placed inside forms rolled as checkboxes or radio buttons
</Callout>
...
Chips can also add other extra rare usages like acting as a Select combined with the popover.
