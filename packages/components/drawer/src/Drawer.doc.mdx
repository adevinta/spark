...
A window overlaid on either the primary window or another drawer window, rendering the content underneath inert.
...
Pick a placement among `right`, `left`, `top` and `bottom`.
