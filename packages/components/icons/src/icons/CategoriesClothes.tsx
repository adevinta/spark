...
export const CategoriesClothes = React.forwardRef(
  (
...
CategoriesClothes.displayName = 'CategoriesClothes'

export const tags = ['CategoriesClothes', '']
