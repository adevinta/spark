...
export const WarningSecurityOutline = React.forwardRef(
  (
    ...
    <svg
      ...
      data-title="WarningSecurityOutline"
...
WarningSecurityOutline.displayName = 'WarningSecurityOutline'

export const tags = ['WarningSecurityOutline', '']
