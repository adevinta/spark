...
export const CalendarCriterias = React.forwardRef(
  (
...
CalendarCriterias.displayName = 'CalendarCriterias'

export const tags = ['CalendarCriterias', '']
