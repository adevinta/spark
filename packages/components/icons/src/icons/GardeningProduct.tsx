...
export const GardeningProduct = React.forwardRef(
  (
...
GardeningProduct.displayName = 'GardeningProduct'

export const tags = ['GardeningProduct', '']
