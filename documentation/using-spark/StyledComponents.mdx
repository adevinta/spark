...
- ["as" polymorphic prop](#as-polymorphic-prop)
...
On our end, since we are using Radix, to address these use cases, we use their `asChild` prop. Check out their [guide here](https://www.radix-ui.com/docs/primitives/guides/composition).
