...
> [Communication](?path=/docs/contributing-communication)

> [Judgment and decision-making](?path=/docs/contributing-judgmentanddecisionmaking)

> [Innovation](?path=/docs/contributing-innovation)

> [Implementation](?path=/docs/contributing-implementation)
